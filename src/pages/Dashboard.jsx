  ...
  return (
    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="md:col-span-2 lg:col-span-1" >
            <div className="h-full py-8 px-6 space-y-6 rounded-xl border-2 border-gray-800 border-opacity-20 bg-primary">
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
        ...
        <div>
            <div className="h-full py-6 px-6 rounded-xl border-2 border-gray-800 border-opacity-20 bg-primary">
                <h5 className="text-xl tracking-tighter">Downloads</h5>
                <div className="my-8">
                    <h1 className="text-5xl font-bold ">64,5%</h1>
                ...
                <table className="mt-6 -mb-2 w-full ">
                    <tbody>
                        <tr>
        ...
        <div>
            <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border-2 border-gray-800 border-opacity-20 bg-primary">
