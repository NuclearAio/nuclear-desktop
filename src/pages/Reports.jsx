...
const Reports = () => {
  ...
  const handleReportModal = () => {
    showReportModal ? setShowReportModal(false) : setShowReportModal(true)
  }

  const handleReportDetail = () => {
    return showReportDetail ? setShowReportDetail(false): setShowReportDetail(true)
  }
  return (
    <div className="">
      <ReportData/>
      {showReportModal ? <AddReport handleModalFunction={handleReportModal}/> : null }
      {showReportDetail ? <ReportDetail handleModalFunc={handleReportDetail}/> : null}
      <aside>
      ...
      <div className="container p-2 mx-auto sm:p-4 -ml-4 ">
        <div style={{ maxHeight: "30rem" }} className="">
          <table className="min-w-full border-b-2 border-hidden overflow-x-auto">
            <colgroup>
              <col />
              <col />
              <col />
            ...
            <thead className="bg-secondary-100 text-xs">
              <tr className="text-left ">
                ...
                <th className="p-3 font-bold text-center">CARD</th>
                <th className="p-3 font-bold text-center">PROXY</th>
                <th className="p-3 font-bold text-center">BOT</th>
            ...
            <tbody>
              <tr className="border-b border-opacity-50 text-xs border-gray-700 bg-primary ">
                ...
                <td className="p-3">
                  <p className="p-0.5 py-1 rounded-full bg-green-500 bg-opacity-50 text-center text-white  text-xs ">
                    success
                  </p>
                </td>
                <td className="p-3">
                ...
                <td className="p-3 text-right flex gap-2 ml-4 cursor-pointer">
                  ...
                  onClick={handleReportDetail}
                   className="px-3 p-1 font-semibold rounded-md bg-secondary-100 hover transition delay-100 ease-in">
              ...
              <tr className="border-b border-opacity-50 text-xs border-gray-700 bg-primary ">
                ...
                <td className="p-3">
                  <p className="p-0.5 py-1 rounded-full bg-rose-700 text-center text-white  text-xs ">
                    decline
                  </p>
                </td>
                <td className="p-3">
